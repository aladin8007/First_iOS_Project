...
class SaveFeedViewController: UIViewController {
    ...
    func setupTableViewDummyData(){
        let news:News = News(title: "iOS", description: "Error lets stop doing this", iconImage: #imageLiteral(resourceName: "cheese_flat"), author: "พยุต", view: 2, createDate: "29/06/600000000000000000", groupLabel: "A1")
        var news2:News = News(title: "Android", description: "5555+", iconImage: #imageLiteral(resourceName: "cat"), author: "แจ็ค", view: 9999, createDate: "29/06/60", groupLabel: "A2")
